...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Reporte de bestsellers | Sitelicon - MiddleWare</title>
      </Head>
                ...
                <CardContent>
                  <Scrollbar>
                    <Table>
                      ...
                      <TableBody>
                        {report.map((row) => {
                          const [first, ...rest] = row.bestsellers;
                          return (
                            <>
                              <TableRow
                              ...
                              >
                                <TableCell
                                  rowSpan={row.bestsellers.length}
                                  sx={{ verticalAlign: 'top' }}
                                >
                                  {formatDate(new Date(row.interval))}
                                </TableCell>
                                <TableCell>{first.product}</TableCell>
                              ...
                              {rest.map((bestseller) => (
                                <TableRow
                                  ...
                                  hover
                                >
                                  <TableCell>{bestseller.product}</TableCell>
                                  <TableCell align="center">
                                    {bestseller.qty}
                                  </TableCell>
