...
export const OrderDetails = (props) => {
  ...
  const finalUsedPoints =
    usedPoints > 0 ? usedPoints : order.reward_points_used || 0;
            ...
            {order.status.id < 4 ? (
              <Stack alignItems="stretch" direction="column" spacing={1}>
                ...
                <Button
                  ...
                  disabled={updatingShippingProvider}
                >
      ...
      <Stack spacing={3}>
        ...
        <PropertyList>
          ...
          <PropertyListItem
            ...
            divider
            label="País"
            value={order.billing_country?.trim() || 'Desconocido'}
          />
          <PropertyListItem
            align={align}
            disableGutters
        ...
        <PropertyList>
          ...
          {order.payment && (
            <>
              ...
              >
                {order.payment.psp_reference ? (
                  <Link
                    variant="body2"
                    href={`https://ca-live.adyen.com/ca/ca/accounts/showTx.shtml?pspReference=${order.payment.psp_reference}&txType=Payment`}
                    target="_blank"
